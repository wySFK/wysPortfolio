                    ...
                    >
                      ...
                      >
                        ...
                        <div className="mt-2">
                          ...
                          <p className="text-[13px] leading-relaxed text-gray-600 max-w-md text-left">A console based rental management system developed using C# and SQL. Allows users to track available rooms, view renter details, and calculate rental costs. Designed for small-scale boarding house or apartment monitoring.</p>
                        </div>
                      </div>
                    </motion.div>
                  </a>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="mt-2">
                          ...
                          <p className="text-[13px] leading-relaxed text-gray-600 max-w-md text-left">A personal portfolio website built with Next.js and Tailwind CSS. Features a clean design with smooth animations and responsive layout.</p>
                        </div>
                      </div>
                    </motion.div>
                  </a>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="mt-2">
                          ...
                          <p className="text-[13px] leading-relaxed text-gray-600 max-w-md text-left">A photography portfolio showcasing a collection of captured moments and stories through the lens. Features landscape, portrait, and street photography.</p>
                        </div>
                      </div>
                    </motion.div>
                  </a>
              ...
              >
                <div className="grid grid-cols-1 gap-8">
                  <div className="text-left">
                    <h2 id="about" ref={aboutRef} className="text-[clamp(80px,25vw,90px)] font-normal leading-[1.1] tracking-[-0.02em] mb-12 mt-20">
                     Get to know me
                    </h2>
                    ...
                    <div className="flex flex-col md:flex-row items-start justify-between gap-16">
                      ...
                      <div className="w-full md:w-1/2 space-y-8">
                        {/* About Text */}
                        <p className="text-[18px] font-mono leading-relaxed tracking-wide text-[#666666] mb-8">
                        ...
                        <div className="space-y-10">
                          <div className="skill-group">
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <h3 className="text-[16px] font-medium">Front End Development</h3>
                            </div>
                            <div className="flex flex-wrap gap-4">
                              <span className="text-[14px] text-[#666666]">HTML</span>
                              <span className="text-[14px] text-[#666666]">CSS</span>
                              <span className="text-[14px] text-[#666666]">JavaScript</span>
                              <span className="text-[14px] text-[#666666]">Responsive Design</span>
                            </div>
                          </div>
                          ...
                          <div className="skill-group">
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <h3 className="text-[16px] font-medium">Development Tools</h3>
                            </div>
                            <div className="flex flex-wrap gap-4">
                              <span className="text-[14px] text-[#666666]">GitHub</span>
                              <span className="text-[14px] text-[#666666]">VS Code</span>
                              <span className="text-[14px] text-[#666666]">Git</span>
                            </div>
                          </div>
                          ...
                          <div className="skill-group">
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <h3 className="text-[16px] font-medium">UI/UX Principles</h3>
                            </div>
                            <div className="flex flex-wrap gap-4">
                              <span className="text-[14px] text-[#666666]">UI Design</span>
                              <span className="text-[14px] text-[#666666]">Prototyping</span>
                              <span className="text-[14px] text-[#666666]">User Research</span>
                              <span className="text-[14px] text-[#666666]">Design Systems</span>
                              <span className="text-[14px] text-[#666666]">Accessibility</span>
                            </div>
                          </div>

                          {/* Certifications */}
                          <div className="mt-60 mb-32">
                            <div className="w-full flex justify-center mb-40 mt-40">
                              <div className="w-full max-w-[90rem] px-8 pl-32">
                                <h2 className="text-[clamp(60px,8vw,100px)] font-normal leading-tight tracking-[-0.02em] text-black text-center translate-x-52">
                                  Certifications
                                </h2>
                              </div>
                            </div>
                            <div className="relative w-screen overflow-hidden flex justify-start mt-20 -translate-x-[10%]">
                              <div className="w-screen overflow-hidden">
                                ...
                                >
                                  ...
                                  <div className="min-w-[400px] bg-white rounded-xl overflow-hidden shadow-md">
                                    <img 
                                      src="/images/CAPSTONE PROJECT WRITING 1 (1).png" 
                                      alt="Capstone Project 1" 
                                      className="w-full h-[300px] object-contain hover:scale-105 transition-transform duration-500"
                                    />
                                  </div>
                                  <div className="min-w-[400px] bg-white rounded-xl overflow-hidden shadow-md">
                                    <img 
                                      src="/images/CAPSTONE PROJECT WRITING 2.png" 
                                      alt="Capstone Project 2" 
                                      className="w-full h-[300px] object-contain hover:scale-105 transition-transform duration-500"
                                    />
                                  </div>
                                  <div className="min-w-[400px] bg-white rounded-xl overflow-hidden shadow-md">
                      ...
                      {/* Right Side - Image */}
                      <div className="relative w-full md:w-[450px] h-[550px] overflow-hidden rounded-2xl -mt-20">
                        <img
